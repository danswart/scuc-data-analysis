...
My aim here is to contribute something to the improvement of learning in our school district; or in any school district.  My basic supposition is that any Board of Trustees should seek data suited to rational policy action aimed at improving **future** learning in the district.
...
The Texas Education Agency (TEA) collects data from every school district in Texas, performs various calculations, and produces reams of reports and tables summarizing their results by academic year.  These reports consist primarily of calculations mandated by the state legislature.  For example, one statistic computed is the so-called 'Accountability Rating' for every district in the state.  Each campus also receives a rating.  
...
Here's an example from a TEA report called a 'Snapshot':
<br>
...
And, here's an example from blah blah:
...
The TEA is charged with preparing the required reports, and they do.  Boards of Trustees are charged with managing and improving their districts.  Managing a district is usually bureaucratic; budgeting,  administration, and resource allocation.  Important, to be sure.


In addition, management should include in their efforts an ongoing assessment of the capability and effectiveness of learning in their district.  The aim should be improvement of learning ***in the future***.


A school district is a large system.  As it turns out, the context of time is crucial to assess the capability and effectiveness of learning.  We all know that 

One of the many reports made available on the TEA website is the 'Snapshot', an impressive compilation of statistics all in one place.  It is well-suited for the needs of the TEA and their reporting responsibilities to the legislature; but completely ill-suited for helping the concerned school board, superintendent, or tax-paying citizen make policy decisions.  
<br>
