...
So, we need a report that will separate the 'common cause' variation (routine variation) we see from the 'special cause' variation that signals a true trend or a shock to the system.  Our current reports do not make that separation for us.
...
What makes a report powerful are these three features:

1. Prior period results for the process ***plotted in time order***, oldest to newest, left to right (the more time periods presented the better).  This is called ***context.***
...
Looking at the results in this table it would be difficult *NOT* to feel concerned about several categories, especially the 'Failing' column.  Looking at this data in the form of bar charts by year would likewise feel disquieting.
...
And, here's one TEA does not provide at all that school boards may been keenly interested in:
<br>
