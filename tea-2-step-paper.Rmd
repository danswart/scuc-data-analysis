...
***Second***, the TEA reports are siloed by academic year making it nearly impossible to create a time-period-by-time-period data frame of any categories or levels the board may wish to analyze.  In fact, without time-period-by-time-period data ***no analysis is possible.***


Through an embarrasing amount of time spent 'data wrangling' I was able to construct from the 'Snapshot' resports a small time-period-by-time-period data frame for STAAR scores for the subject-matter categories at the district-level for the academic years ended 2016-2022.  (No STAAR scores were available for the 2019 academic year.)

Here we see a comprehensive view of all subject categories for one level of achievement for all years in the sample:
...
All data I've seen so far as a board member are descriptive only, with no analysis present.  
<br>
...
The important information for understanding district capability, and the prediction of future performance, is contained in the time-period-by-time-period data frame.  The order of the data matters.  The more periods included in the analysis, the stronger the evidence for your inferences.
