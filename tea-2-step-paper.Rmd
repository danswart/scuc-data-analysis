...
I look forward to the day when everyone at every level learns to use two simple tools that make possible and encourages the study of methods of learning and administration (inputs) and their impact on the results observed (outputs) at the local level.  Those interested in using data to help improve learning in their district please feel free to contact me."</strong></p>
...
\\large{\\textbf{I look forward to the day when everyone at every level learns to use two simple tools that make possible and encourages the study of methods of learning and administration (inputs) and their impact on the results observed (outputs) at the local level.  Those interested in using data to help improve learning in their district please feel free to contact me."}}
  \\end{minipage}\\\\[5pt]
  \\begin{minipage}{0.95\\textwidth}
    \\raggedleft
    \\small{Dan Swart}\\\\
...
This paper is for anyone striving to improve learning in their school district and think data can help them.  Anyone can use the simple theory and techniques to significantly improve their teaching, classrooms, campuses, departments and districts.  
...
knitr::kable(example_metrics_table, "simple", col.names = c("Example Metric", "Example Metric"), booktabs = TRUE, caption = "**Here are just a few examples of data that come our way:**") %>% 
...
knitr::kable(example_metrics_table, "pipe", col.names = c("Example Metric", "Example Metric"), caption = "Here are just a few examples of data that come our way:") %>% 
...
Should we do nothing when we think we need a change?  ***ABSOLUTELY NOT!***  However, **WHAT** we do and **HOW** we do it is very different under each condition.  Those who simply want 'change', without regard to what is appropriate, will nearly always make things worse.
<br>
<br>
