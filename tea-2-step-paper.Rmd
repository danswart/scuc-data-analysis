...
***My hope here is to ignite the collaborative interest and energy required to put these critical resources in the hands of all school boards and administrations.***
...
Any evaluation of results must provide us with evidence beyond 'snapshot' reports, or even two or three point comparisons, to form an opinion on how a process is operating.  As discussed later, trends cannot be established with only two or three data points on a ***'description-only'*** report.
...
It is ridiculously easy to plot dots in time order on a piece of paper and draw lines between the dots.  Maria in second grade can do it.  It takes very little training to learn how to construct and use a chart.  When people in the organization begin 'plotting the dots' amazing ideas and insights bubble up from the people closest to the action - where it is most valuable.  
...
Management in all forms is prediction.  Therefore, management should use analytic instead of description-only information.  Management should focus on improvement of processes for future results, not solely on judgment of past results. 
