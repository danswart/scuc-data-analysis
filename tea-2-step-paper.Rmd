...
<blockquote class="my-quote">
  <p><strong>"My aim here is to contribute something to the improvement of learning in our school district; or any school district.  My basic supposition is that Boards of Trustees will welcome information designed to help them create rational policy action aimed at improving future learning in their district.."</strong></p>
  <p class="quote-author">          — Professor Strabismis</p>
  <p class="quote-description">         - University of Mars</p>
</blockquote>
')
...
\\begin{tcolorbox}[colback=white, colframe=teal, boxrule=2pt, arc=4pt]
  \\textbf{"My aim here is to contribute something to the improvement of learning in our school district; or any school district.  My basic supposition is that Boards of Trustees will welcome information designed to help them create rational policy action aimed at improving future learning in their district."} \\\\
  \\textnormal{— Professor Strabismus} \\\\
...
Although this aggregation permits TEA to render abstract judgements about a district or campus, the lack of specificity renders these reports unsuitable for understanding any particular categories or levels your board may be interested in monitoring or improving.
<br>
...
The crucial information for analysis of process and district capability (and the prediction of future performance) is contained in the order of occurance found in the time-period-by-time-period data.  ***The more periods included in the analysis, the stronger the evidence for your inferences from the charts.***  
